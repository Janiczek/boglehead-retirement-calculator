...
var $gicentre$elm_vegalite$VegaLite$Area = 0;
...
var $gicentre$elm_vegalite$VegaLite$area = $gicentre$elm_vegalite$VegaLite$mark(0);
...
var $gicentre$elm_vegalite$VegaLite$MText = function (a) {
	return {$: 61, a: a};
};
var $gicentre$elm_vegalite$VegaLite$maText = $gicentre$elm_vegalite$VegaLite$MText;
var $gicentre$elm_vegalite$VegaLite$MXOffset = function (a) {
	return {$: 72, a: a};
};
...
var $gicentre$elm_vegalite$VegaLite$widthOfContainer = _Utils_Tuple2(
	3,
	$elm$json$Json$Encode$string('container'));
var $author$project$Main$toSpec = F2(
	function (model, rows) {
		var retirementAgeEnc = A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$gicentre$elm_vegalite$VegaLite$pName('retirement age'),
						$gicentre$elm_vegalite$VegaLite$pOrdinal
					])));
		var retirementAgeData = A2(
			$elm$core$Basics$composeL,
		...
		var enc = A2(
			...
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							$gicentre$elm_vegalite$VegaLite$pName('age'),
							$gicentre$elm_vegalite$VegaLite$pOrdinal,
							$gicentre$elm_vegalite$VegaLite$pAxis(
							_List_fromArray(
								[
									$gicentre$elm_vegalite$VegaLite$axTitle('Age')
								]))
						]))),
			A2(
				$gicentre$elm_vegalite$VegaLite$position,
				...
				_List_fromArray(
					[
						$gicentre$elm_vegalite$VegaLite$pName('balance'),
						$gicentre$elm_vegalite$VegaLite$pQuant,
						$gicentre$elm_vegalite$VegaLite$pAxis(
						_List_fromArray(
							[
								$gicentre$elm_vegalite$VegaLite$axTitle('Balance')
							]))
					])));
		var data = A2(
			$elm$core$Basics$composeL,
		...
		return $gicentre$elm_vegalite$VegaLite$toVegaLite(
			_List_fromArray(
				[
					A2($gicentre$elm_vegalite$VegaLite$title, 'Balance by age', _List_Nil),
...
var $author$project$Main$init = function (flags) {
	var modelWithoutComputed = {I: _List_Nil, B: 10, L: 80, M: 3, N: 27, O: 6, P: (5700 * 20) * 11, D: 65, Q: (5700 * 20) * 11, R: 50000 * 12};
...
var $author$project$Main$tryFloat = F3(
	function (string, model, setter) {
		var _v0 = $elm$core$String$toFloat(string);
		if (_v0.$ === 1) {
			return model;
		} else {
			var _float = _v0.a;
			return setter(_float);
		}
	});
var $author$project$Main$tryInt = F3(
	function (string, model, setter) {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		return $author$project$Main$recompute(
			function () {
				switch (msg.$) {
					case 0:
						var string = msg.a;
						return A3(
							$author$project$Main$tryInt,
							string,
							model,
							function (n) {
...
var $author$project$Main$SetFinalReturnPercent = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$SetInitialAge = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$SetInitialReturnPercent = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$SetInitialSalary = function (a) {
	return {$: 2, a: a};
};
var $author$project$Main$SetRetirementAge = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$SetRetirementSalary = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$SetRetirementWithdrawal = function (a) {
	return {$: 8, a: a};
};
...
var $author$project$Main$formatMoney = function (n) {
			...
			if (_v1.b) {
				if (_v1.b.b) {
					if (!_v1.b.b.b) {
						...
						return _Utils_Tuple2(
							whole_,
							$elm$core$Maybe$Just(decimal));
					} else {
						break _v1$2;
					}
				} else {
					var whole_ = _v1.a;
					return _Utils_Tuple2(whole_, $elm$core$Maybe$Nothing);
				}
			} else {
				break _v1$2;
			}
	...
	var whole = _v0.a;
	var maybeDecimal = _v0.b;
	var decimalFormatted = A3(
		$elm$core$String$padRight,
		2,
		'0',
		A2($elm$core$Maybe$withDefault, '00', maybeDecimal));
	var wholeFormatted = A2(
		$elm$core$String$join,
		$author$project$Main$thousandSeparator,
	...
	return _Utils_ap(
		wholeFormatted,
		_Utils_ap($author$project$Main$decimalDot, decimalFormatted));
};
...
var $author$project$Main$viewTable = function (computed) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('table-wrapper')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$tbody,
						_List_Nil,
						A2($elm$core$List$map, $author$project$Main$viewRow, computed))
					]))
			]));
};
